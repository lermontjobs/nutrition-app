...
const foods = [
  ...
  { name: "שוק עוף", nameEn: "Chicken Thigh", category: "protein", servingSize: 100, calories: 130, protein: 20, carbs: 0, fat: 5.5, source: "usda" },
  { name: "סלמון", nameEn: "Salmon", category: "protein", servingSize: 100, calories: 208, protein: 20, carbs: 0, fat: 13, source: "usda" },
  { name: "טונה בקופסה", nameEn: "Canned Tuna", category: "protein", servingSize: 100, calories: 84, protein: 20, carbs: 0, fat: 0.5, source: "usda" },
  ...
  { name: "חומוס", nameEn: "Chickpeas", category: "carbs", servingSize: 100, calories: 164, protein: 8.9, carbs: 27, fat: 2.6, source: "usda" },
  ...
  { name: "טחינה גולמית", nameEn: "Tahini", category: "fats", servingSize: 30, calories: 180, protein: 5, carbs: 6, fat: 16, source: "il_standard" },
  ...
  { name: "חמוס מוכן", nameEn: "Hummus", category: "prepared", servingSize: 100, calories: 177, protein: 8, carbs: 20, fat: 8, source: "il_estimated", isEstimated: true },
...
async function main() {
  ...
  if (count > 0) { console.log("Foods already seeded:", count); prisma.$disconnect(); return }
  for (const f of foods) { await prisma.food.create({ data: { ...f, isEstimated: f.isEstimated || false } }) }
